...
fungi[,2329]
fun <- fungi
fun[,2329] <- gsub(",s.*","",fun[,2329])
fun[,2329] <- ifelse(grepl("g:",fun[,2329]),gsub(".*g:","",fun[,2329]),"Unassign")
fun <- fun[,-1]
...
p
ggsave("fun_alpha.pdf",width = 9.32,height = 7.22,units = "in")
